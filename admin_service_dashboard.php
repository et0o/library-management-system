...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="IT"/>IT<div style="margin-left:80px"><input type="radio" name="branch" value="CSE"/>CSE<input type="radio" name="branch" value="Core"/>Core</div>
            </div>   
